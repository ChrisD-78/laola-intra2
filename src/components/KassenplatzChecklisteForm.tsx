...
interface KassenplatzChecklisteData {
 ...
 const checklistItems = [
  ...
  { id: 'kasse_anmelden', label: 'Kasse anmelden', section: 'Frühschicht' },
  ...
  { id: 'korb_wechseln', label: 'Korb wechseln', section: 'Frühschicht' },
  { id: 'temperaturmessung_eis', label: 'Temperaturmessung Eis', section: 'Frühschicht' },
