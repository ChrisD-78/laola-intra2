...
-- 4. Erstelle das neue DIN 19643 Allgemein Quiz und füge Fragen ein
DO $$
DECLARE
  quiz_id UUID;
BEGIN
  ...
  RAISE NOTICE 'Quiz "DIN 19643 Allgemein" erfolgreich aktualisiert!';
  RAISE NOTICE 'Quiz-ID: %', quiz_id;
  RAISE NOTICE '21 Fragen eingefügt';
END $$;
